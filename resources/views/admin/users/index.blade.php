                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                ...
                                <input type="text" name="search" id="search" class="form-control form-control-sm search-bar" placeholder="{{__('messages.search')}}" onkeyup="MakeUsersTable()">
                            </div>
                            <div class="d-flex align-items-center text-nowrap mr-1">
                                ...
                                <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="{{__('messages.btns.add_user')}}" onclick="window.location.href='{{route('users.add')}}';">
                                    <i class="fa fa-plus mr-1"></i> {{__('messages.btns.add_user')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="datatable1 table table-stripped w-100" id="usersTable">
                                <thead>
                                    <tr>
                                        <td>#</td>
                                        ...
                                        <td>{{__('messages.table_elements.password')}}</td>
