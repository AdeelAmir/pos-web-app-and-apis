    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 offset-md-0 grid-margin stretch-card">
                <form action="{{ route('damage_replace.store') }}" id="" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="card mb-3">
                        <div class="card-body">
                            <input type="hidden" name="jsonProducts" id="jsonProducts" class="form-control" value="">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <span for="items">{{__('messages.items')}} <span class="text-danger">*</span></span>
                                ...
                                <div class="col-md-12">
                                    <div class="row d-flex justify-content-end px-3">
                                        <div class="col-md-3 d-flex justify-content-between border border-secondary text-primary px-3 py-2">
                                            ...
                                            <div>
                                                {{App\Helpers\SiteHelper::settings()['Currency_Icon']}}<span id="damageGrandTotal">0</span>
                                                <input type="hidden" id="damage_grand_total" name="grand_total" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
