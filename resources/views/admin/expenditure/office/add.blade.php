...
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="mb-3">
                <h3 class="mb-0">{{ __('messages.add_office_expenditure_title') }}</h3>
            </div>
            <div class="col-md-12 grid-margin stretch-card">
                <form action="{{ route('expenditure.office.store') }}" id="" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="repeater-custom-show-hide">
                                    <div data-repeater-list="expense_repeater">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2 d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='{{route('expenditure.office')}}'">
