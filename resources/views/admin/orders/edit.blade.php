    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 offset-md-0 grid-margin stretch-card">
                <form action="{{ route('orders.update') }}" id="" enctype="multipart/form-data" method="post">
                    @csrf
                    <input type="hidden" name="order_id" id="id" class="form-control" value="{{ $order->id }}">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="seller_id" id="seller_id" class="form-control form-select select2" required>
                                        ...
                                        @foreach ($sellers as $seller)
                                            <option value="{{ $seller->id }}" @if($order->seller_id == $seller->id) selected @endif>{{ $seller->name . ' / ' . $seller->id }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="payment_type" id="payment_type" class="form-control form-select select2" required>
                                        ...
                                        <option value="credit" @if($order->payment_type == 'credit') selected @endif>Credit</option>
                                    </select>
                                </div>
