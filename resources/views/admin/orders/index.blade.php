                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                ...
                                <input type="text" name="search" id="search" class="form-control form-control-sm search-bar" placeholder="Search" onkeyup="MakeOrdersTable()">
                            </div>
                            <div class="d-flex align-items-center text-nowrap mr-1">
                                ...
                                {{-- <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="Add Order" onclick="window.location.href='{{route('orders.add')}}';">
                                    <i class="fa fa-plus mx-2"></i>Order
                                </button> --}}
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="datatable1 table table-stripped w-100" id="orderTable">
                                <thead>
                                    <tr>
                                        <td>#</td>
                                        ...
                                        <td>{{__('messages.table_elements.sale_type')}}</td>
