...
<style>
    @media print {
        @page {
            size: A4 portrait; /* Specify the size and orientation */
        ...
        #printableArea, #printableArea * {
            display: block; /* Show the printable area and its children */
        }
    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="mb-3 d-flex justify-content-between">
                ...
                <div class="">
                    <button type="submit" class="btn btn-primary me-3" onclick="openSalePrintModal('printableArea')">
            ...
            <div class="col-md-12 offset-md-0 grid-margin stretch-card" id="printableArea">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
