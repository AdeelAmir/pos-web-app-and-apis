    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 offset-md-0 grid-margin stretch-card">
                <form action="{{ route('sales.store') }}" id="sale-form" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="payment_type" id="price_type" class="form-control form-select select2" onchange="PriceTypeSelected()" required>
                                        <option value="">{{__('messages.select')}}</option>
                                        <option value="retail_price" selected>Retail Price</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="bonus" id="bonus-yes" value="1" required>
                                            <label class="form-check-label" for="bonus-yes">{{__('messages.yes')}}</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="bonus" id="bonus-no" value="0" required>
