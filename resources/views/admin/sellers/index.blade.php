...
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="mb-3">
                <h3 class="mb-0">{{__('messages.sellers')}}</h3>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                ...
                                <input type="text" name="search" id="search" class="form-control form-control-sm search-bar" placeholder="{{__('messages.search')}}" onkeyup="MakeSellersTable()">
                            </div>
                            <div class="d-flex align-items-center text-nowrap mr-1">
                                ...
                                <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="{{__('messages.btns.add_seller')}}" onclick="window.location.href='{{route('sellers.add')}}';">
                                    <i class="fa fa-plus mr-1"></i> {{__('messages.btns.add_seller')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="datatable1 table table-stripped w-100" id="sellersTable">
                                <thead>
                                    <tr>
                                        <td>#</td>
