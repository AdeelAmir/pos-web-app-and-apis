                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center text-nowrap mr-1">
                                ...
                                <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="{{__('messages.btns.add_return')}}" onclick="window.location.href='{{route('returns.add')}}';">
                                    <i class="fa fa-plus mx-2"></i>{{__('messages.return')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="datatable1 table table-stripped w-100" id="returnTable">
                                <thead>
                                    <tr>
