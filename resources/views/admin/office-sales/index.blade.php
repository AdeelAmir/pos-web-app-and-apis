...
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="mb-3 d-flex justify-content-between">
                <h3 class="mb-0">{{ __('messages.office_sales') }}</h3>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div class="d-flex align-items-center">
                                ...
                                <input type="text" name="search" id="search" class="form-control form-control-sm search-bar me-2" placeholder="{{ __('messages.search') }}" onkeyup="MakeOfficeSalesTable()">
                            ...
                            <div class="d-flex align-items-center text-nowrap">
                                ...
                                <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="{{__('messages.btns.add_office_sale')}}" onclick="window.location.href='{{route('sales.office.add')}}';">
                                    <i class="fa fa-plus me-1"></i> {{__('messages.btns.add_office_sale')}}
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="datatable1 table table-stripped w-100" id="officeSaleTable">
                                    <thead>
                                        <tr>
    ...
    @include('admin.office-sales.status')
@endsection