...
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="mb-3">
                <h3 class="mb-0">{{ __('messages.loan_title') }}</h3>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center text-nowrap mr-1">
                                ...
                                {{-- <button type="button" class="btn btn-primary mb-2 mb-md-0" data-toggle="tooltip" title="Add Exchange City" onclick="window.location.href='{{route('exchange_city.add')}}';">
                                    <i class="fa fa-plus mx-2"></i>Exchange City
                                </button> --}}
                            </div>
                        </div>
                    </div>
