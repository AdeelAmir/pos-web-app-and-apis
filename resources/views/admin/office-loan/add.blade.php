                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="city_id">Warehouse City <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="selling_city_id">Selling City <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="office_payment_type_cash">Cash</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="office_payment_type" id="office_payment_type_credit" value="Credit" required>
                                            <label class="form-check-label" for="office_payment_type_credit">Credit</label>
                                        </div>
                                    </div>
